import styles from "../../../../../styles/video/comment/ResponsesBlock/ResponsesBlock.module.scss";
...
export function ResponsesBlock(props:{responseNumber:number}){
  ...
  for(let i = 0; i < props.responseNumber; i++){
    objectArr.push(<ResponsesBlock key={i} responseNumber={0}/>);
  }

	return(
    <li className={styles.responses_block}>

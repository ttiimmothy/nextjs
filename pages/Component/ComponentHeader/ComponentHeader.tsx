...
export function ComponentHeader(props:{header:string,color?:string,padding?:number,borderColor?:string}){
	return(
      ...
      <div className={styles.border_line} style={{backgroundColor:props.borderColor ? props.borderColor : "#f2f2f2",left:props.padding === 0 ? 3 : 10,right:props.padding === 0 ? 3 : 10}}></div>

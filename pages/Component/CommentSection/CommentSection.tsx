import styles from "../../../styles/CommentSection/CommentSection.module.scss";
  ...
  const [allComments,setAllComments] = useState(false);
    ...
    <div className={styles.comment_section}>
      ...
      <ul className={styles.others_comments}>
        <li className={styles.others_comment}>
                ...
                <div className={styles.responses_to_comment}>
                  {!openAllResponses &&
                    <div className={styles.responses} onClick={() => {
                      ...
                      <span className={styles.responses_number}>1個回覆</span>
                    </div>
                  }
                  {openAllResponses && <ResponsesBlock/>}
                </div>
              </div>
            </div>
          </article>
      ...
      {openMoreComments && <CommentsBlock/>}
          ...
          <button className={styles.more_comments_button} onClick={() => {
            ...
            <div className={styles.more_comments_button_section}>
              ...
              <div className={styles.down_icon}>
                <FontAwesomeIcon icon="chevron-down" height={12} width={12} className={styles.fontawsome_icon}/>
              </div>
            </div>
          </button>
        </div>

...
const Video:NextPage = () => {
  ...
  const topButtonsOffset = useRef<any>(null);
  ...
  useEffect(() => {
    ...
    <div className={`${style.App} ${styles.video} ${styles.pid}`}>
      ...
      <PageHeader toggle={toggle} openToggle={setToggle} search={search} openSearch={setSearch} topButtonsOffset={topButtonsOffset.current ? topButtonsOffset.current.getBoundingClientRect().top : 100} smallWord={smallWord} mediumWord={mediumWord} largeWord={largeWord} setSmallWord={setSmallWord} setMediumWord={setMediumWord} setLargeWord={setLargeWord} video={video}/>
              ...
              {video &&
                <div className={styles.video_player_with_description}>
                  <header className={styles.video_header}>
                    ...
                    <div className={topButtonsOffset.current.getBoundingClientRect().top < 50 ? styles.hide_top_buttons : styles.top_buttons} ref={topButtonsOffset}>
                      <LikeButtonWithEmojiBox topButtonsOffset={topButtonsOffset.current ? topButtonsOffset.current.getBoundingClientRect().top : 100}/>
                      ...
                      <ShareButtonWithShareBox topButtonsOffset={topButtonsOffset.current ? topButtonsOffset.current.getBoundingClientRect().top : 100}/>
                      <MoreOptionsButtonWithMoreBox smallWord={smallWord} mediumWord={mediumWord} largeWord={largeWord} setSmallWord={setSmallWord} setMediumWord={setMediumWord} setLargeWord={setLargeWord} topButtonsOffset={topButtonsOffset.current ? topButtonsOffset.current.getBoundingClientRect().top : 100}/>
                    </div>
                  </header>

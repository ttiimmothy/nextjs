...
const Video:NextPage = () => {
  ...
  useEffect(() => {
    ...
    <div className={`${style.App} ${styles.video} ${styles.pid}`}>
      ...
      <PageHeader toggle={toggle} openToggle={setToggle} search={search} openSearch={setSearch} displayDateOffset={displayDateOffset.current ? displayDateOffset.current.getBoundingClientRect().top : 120} displayDateOffsetForPageHeaderTopButtons={displayDateOffset.current ? displayDateOffset.current.getBoundingClientRect().top : 0} smallWord={smallWord} mediumWord={mediumWord} largeWord={largeWord} setSmallWord={setSmallWord} setMediumWord={setMediumWord} setLargeWord={setLargeWord} video={video} windowWidth={windowDimensions.width} scrollToComment={scrollToComment}/>
                ...
                <div className={styles.video_player_with_description}>
                  <header className={styles.video_header}>
                    ...
                    <div className={!displayDateOffset.current ? styles.top_buttons : (windowDimensions.width < 700 && displayDateOffset.current.getBoundingClientRect().top < 65) || (windowDimensions.width >= 700 && displayDateOffset.current.getBoundingClientRect().top < 15) ? styles.hide_top_buttons : styles.top_buttons}>
                      <LikeButtonWithEmojiBox displayDateOffset={displayDateOffset.current ? displayDateOffset.current.getBoundingClientRect().top : 120} windowWidth={windowDimensions.width}/>
                      ...
                      <ShareButtonWithShareBox displayDateOffset={displayDateOffset.current ? displayDateOffset.current.getBoundingClientRect().top : 120} windowWidth={windowDimensions.width}/>
                      <MoreOptionsButtonWithMoreBox smallWord={smallWord} mediumWord={mediumWord} largeWord={largeWord} setSmallWord={setSmallWord} setMediumWord={setMediumWord} setLargeWord={setLargeWord} displayDateOffset={displayDateOffset.current ? displayDateOffset.current.getBoundingClientRect().top : 100} windowWidth={windowDimensions.width}/>
                    </div>
                  </header>
